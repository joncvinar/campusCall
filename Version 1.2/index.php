...
$failedmessage = "Wrong Username / Password";
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="authenticate.php" method="post">
                  <br />
                  <p >
                  <?php  
                       if(isset($failedmessage)){  
                        echo '<span  style="color:#FF0000;text-align:right;">Wrong Username / Password</span>';
                    }  
                    ?> 
